...
from app.api.resources.gallery import AlbumListResource
from app.models import User, Album

class ApiAlbumListResourceTestCase(unittest.TestCase):
    '''Test Api AlbumList Resource '''
    ...
    def setUp(self):
        ...
        self.url = api.url_for(AlbumListResource)
    ...
    def test_album_list_resource_get_without_token(self):
        response = self.client.get(self.url, headers=self.get_headers())
        self.assertEqual(response.status_code,401)

    def test_album_list_resource_get_with_valid_token(self):
